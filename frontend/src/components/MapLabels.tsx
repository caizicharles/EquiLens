...
const WATER_LABELS = [
  ...
  { label: 'Atlantic Ocean', lat: 56.5, lng: -9.2, size: 14 },
...
const PRIMARY_CITIES: CityData[] = [
  {
    ...
    glowShadow: '0 0 14px rgba(126, 191, 78, 0.6)',
    glowShadowHover: '0 0 28px rgba(126, 191, 78, 0.8)',
    labelSide: 'right',
    coord: '51.5\u00B0N, 0.1\u00B0W',
  },
  {
    ...
    glowShadow: '0 0 14px rgba(125, 187, 216, 0.6)',
    glowShadowHover: '0 0 28px rgba(125, 187, 216, 0.8)',
    labelSide: 'right',
    coord: '56.0\u00B0N, 3.2\u00B0W',
  },
  {
...
const TEXT_SHADOW_STRONG =
  '0 1px 6px rgba(255,255,255,0.95), 0 0 2px rgba(255,255,255,0.8)';
const TEXT_SHADOW_MEDIUM =
  '0 1px 4px rgba(255,255,255,0.9), 0 0 2px rgba(255,255,255,0.6)';
...
export default function MapLabels({ width, height }: MapLabelsProps) {
  return (
    ...
    >
      ...
      <div style={{ pointerEvents: 'auto', zIndex: 5 }}>
